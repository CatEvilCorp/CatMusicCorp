...
from CatMusicCorp.modules.play import generate_cover
from CatMusicCorp.modules.play import arq
from CatMusicCorp.modules.play import cb_admin_check
from CatMusicCorp.modules.play import transcode
from CatMusicCorp.modules.play import convert_seconds
from CatMusicCorp.modules.play import time_to_seconds
from CatMusicCorp.modules.play import changeImageSize
from CatMusicCorp.config import BOT_NAME as bn
from CatMusicCorp.config import DURATION_LIMIT
from CatMusicCorp.config import UPDATES_CHANNEL as updateschannel
from CatMusicCorp.config import que
from CatMusicCorp.function.admins import admins as a
from CatMusicCorp.helpers.errors import DurationLimitError
from CatMusicCorp.helpers.decorators import errors
from CatMusicCorp.helpers.admins import get_administrators
from CatMusicCorp.helpers.channelmusic import get_chat_id
from CatMusicCorp.helpers.decorators import authorized_users_only
from CatMusicCorp.helpers.filters import command
from CatMusicCorp.helpers.filters import other_filters
from CatMusicCorp.helpers.gets import get_file_name
from CatMusicCorp.services.callsmusic import callsmusic
from CatMusicCorp.services.callsmusic import client as USER
from CatMusicCorp.services.converter.converter import convert
from CatMusicCorp.services.downloaders import youtube
from CatMusicCorp.services.queues import queues
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @CatMusicCorp to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
